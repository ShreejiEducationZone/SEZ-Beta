...
const ToastNotification: React.FC<ToastNotificationProps> = ({ toast, onClose }) => {
    ...
    return (
        <div
            ...
            className="flex items-center w-full max-w-sm p-4 text-card-foreground bg-card/80 backdrop-blur-lg rounded-xl shadow-soft-lg border border-border touch-none"
            role="alert"
        >
