...
const WorkPoolFilterBar: React.FC<WorkPoolFilterBarProps> = ({
    ...
    <div className="bg-card p-4 rounded-2xl shadow-soft border border-border mb-6 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-7 gap-4 items-end">
        {/* Search Bar */}
        <div className="relative md:col-span-3 lg:col-span-2">
            ...
            <div className="mt-1 relative rounded-md">
                ...
                <input
                    ...
                    name="searchQuery"
                    id="search"
                    className="block w-full h-10 pl-10 pr-3 rounded-lg border border-border bg-background focus:ring-2 focus:ring-primary/50 transition-colors duration-200"
