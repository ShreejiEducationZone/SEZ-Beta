...
const DoubtFilterBar: React.FC<DoubtFilterBarProps> = ({
    ...
    return (
        <div className="bg-card p-4 rounded-2xl shadow-soft border border-border mb-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 items-end">
            {/* Search Bar */}
            <div className="relative sm:col-span-2 md:col-span-4 lg:col-span-2" ref={searchRef}>
                ...
                <div className="mt-1 relative rounded-md">
                    ...
                    <input
                        ...
                        id="search"
                        autoComplete="off"
                        className="block w-full h-10 pl-10 pr-3 rounded-lg border border-border bg-background focus:ring-2 focus:ring-primary/50"
                    ...
                    {showSuggestions && studentSuggestions.length > 0 && (
                        <ul className="absolute z-10 w-full bg-card border border-border rounded-md mt-1 shadow-lg max-h-60 overflow-auto">
            ...
            <div>
                <button
                    ...
                    className="w-full h-10 px-4 rounded-lg bg-muted text-muted-foreground hover:bg-border text-sm font-medium"
                >
                    Clear All
                </button>
            </div>
